...
export function HeartIcon({ size = 15, color = 'currentColor', filled = false }: IconProps) {
  return (
...
export function CommentIcon({ size = 15, color = 'currentColor' }: IconProps) {
  return (
...
export function EyeIcon({ size = 15, color = 'currentColor' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2">
...
export function BookmarkIcon({ size = 15, filled = false }: IconProps) {
  return (
